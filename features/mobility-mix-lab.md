...
- Plain-language scenario choices.
- Immediate feedback without requiring technical knowledge.
- Clear separation between simulation results and published cross-study evidence.
- No claim that surrogate TTC indicators are observed crashes.

[Try the Mobility Mix Lab](https://mobility-safety-intelligence.streamlit.app/)
